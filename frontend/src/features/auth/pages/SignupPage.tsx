    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--color-pastel-bg)] via-[var(--color-pastel-bg-alt)] to-[#EFF6FF] dark:from-[var(--color-dark-bg)] dark:via-[var(--color-dark-bg)] dark:to-[var(--color-dark-bg-alt)]">
      ...
      <div className="w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-[var(--color-pastel-text-secondary)] dark:text-[var(--color-dark-text-secondary)]">Create your account to get started</p>
        </div>
        ...
        <div className="bg-white/80 dark:bg-[var(--color-dark-column)] backdrop-blur-sm p-8 rounded-2xl shadow-pastel-lg dark:shadow-none border border-[var(--color-pastel-border)]/20 dark:border-[var(--color-dark-border-subtle)]">
          <h2 className="text-xl font-bold mb-6 text-[var(--color-pastel-text-primary)] dark:text-[var(--color-dark-text-primary)]">Create account</h2>

          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1.5 text-[var(--color-pastel-text-secondary)] dark:text-[var(--color-dark-text-secondary)]">Full Name</label>
              <input
                type="text"
                value={fullName}
          ...
          <p className="mt-6 text-center text-sm text-[var(--color-pastel-text-secondary)] dark:text-[var(--color-dark-text-secondary)]">
            ...
            <Link to="/login" className="text-[var(--color-pastel-accent)] dark:text-[var(--color-dark-accent)] hover:underline font-semibold">
              Sign in
            </Link>
          </p>
        </div>
